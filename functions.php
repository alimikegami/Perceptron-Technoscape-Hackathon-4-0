...
function filterPencarian($data)
{
    $hargaMin = $data['hargaMin'];
    $hargaMax = $data['hargaMax'];
    $bintang = [];
    ...
    var_dump($data);
    die;
    // $query = "SELECT * accommodation INNER JOIN rating on accommodation.accommodation_id=rating.accommodation_id WHERE (accommodation_price_per_night BETWEEN '$hargaMin' )"
}
